...
const Contact = () => {
  return (
    <section id="contact">
        ...
        {/* LinkedIn */}
        <div className="flex gap-2 md:gap-4 mb-6">
          <img src="src\assets\linkedin.png" alt="linkedin" className="w-8 h-8 md:w-10 md:h-10" />
        ...
        {/* Github */}
        <div className="flex gap-2 md:gap-4 mb-6">
          <img src="src\assets\githubicon.png" alt="github" className="w-8 h-8 md:w-10 md:h-10" />
