...
export default function Navbar() {
  return (
    <nav className="flex md:p-4 md:justify-between justify-between shadow-md bg-white sticky top-0 z-50 items-center w-full">
      <img src="src/assets/JMIcon.png" alt="logo" className="w-12 h-12 items-start" />
      <ul className="flex md:gap-6 gap-4 md:mr-148 ">
